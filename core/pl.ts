export default {
  ...
  commands: {
    ...
    bot: [
      ...
      "🌳 Środowisko: *{16}*",
      "⌚ Czas działania: *{17}*",
      "🆙 Data aktualizacji: *{18}* {3} *{19}*",
      "\n🔌 _*KLIENT*_:",
      "🔖 Wersja: *{20}*",
      "🌳 Środowisko: *{21}*",
      "⌚ Czas działania: *{22}*",
      "🆙 Data aktualizacji: *{23}* {3} *{24}*",
      "\n🪙 _*EKONOMIA*_:",
      "🔖 Wersja: *{25}*",
      "🌳 Środowisko: *{26}*",
      "⌚ Czas działania: *{27}*",
      "🆙 Data aktualizacji: *{28}* {3} *{29}*",
      "\n📱 Ten bot został stworzony *całkowicie za darmo* na stronie {30}, Ty również możesz to zrobić aby korzystać z niego na swoich grupach!",
      "\n🤗 Dołącz na nasz *serwer Discord* aby być na bieżąco z nowościami dotyczącymi *Ambienta*, a także uzyskać pomoc i odpowiedzi na pytania: {31}",
    ],
    group: {
    ...
    premium: [
      ...
      "\n💎 Twój stan Premium: {1}",
      "\n🔗 Twój link do szczegółów wsparcia i Premium: {2}",
      "\n🤗 Masz pytania lub potrzebujesz pomocy? Dołącz na nasz *serwer Discord*: {3}",
      "\n🫶🏻 Dziękujemy za wspieranie *Ambienta*!",
    ],
    purge: {
      usage: [
