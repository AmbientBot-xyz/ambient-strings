export default {
  global: {
    ...
    limitReached: [
      ...
      "💡 Znasz kogoś, kto już posiada aktywne Premium? Może ulepszyć tę grupę aby pozbyć się ograniczeń dla wszystkich jej członków. Ulepszeniami można zarządzać pod komendą *{1}*.",
    ],
    premiumExtended: [
    ...
    authenticationPrompt: [
      ...
      "🆔 ID: *{2}*",
      "{3} Urządzenie: *{4}*",
      "⏱️ Data rozpoczęcia: *{5}*",
      "\n🟢 Zareaguj na tę wiadomość używając 👍🏼 (odcień nie ma znaczenia) lub ✅ w ciągu *{6} sekund* TYLKO, jeśli powyższe informacje zgadzają się i chcesz uwierzytelnić to żądanie.",
      ...
      "\n🟡 Aby zarządzać swoim powiązaniem z serwisem *{1}*, skorzystaj z komendy *{7}*.",
      "\n🤗 Masz pytania lub potrzebujesz pomocy? Dołącz na nasz *serwer Discord*: {8}",
    ],
    ...
    authenticationPromptAuthorized: [
      "✅ {0}, żądanie *{1}* z urządzenia {2} *{3}* zostało przez Ciebie uwierzytelnione. Możesz teraz wrócić pod swój link: {4}\n",
      "⌚ Masz od teraz kolejne *{5} minut* aby dokończyć łączenie konta.",
    ],
    authenticationPromptRejected: "⛔️ {0}, żądanie *{1}* z urządzenia {2} *{3}* zostało przez Ciebie odrzucone.",
    authenticationPromptTimeout: "⌛ {0}, czas na uwierzytelnienie żądania *{1}* z urządzenia {2} *{3}* minął. Zostało ono automatycznie odrzucone.",
    authenticationPromptSuperseded:
  ...
  commands: {
    ...
    group: {
      collecting: "⏳ Zbieram informacje o grupie...",
        ...
        "🔗 Link do zaproszenia (Ambient): {19}",
        "♾️ Link do zaproszenia (Meta): {20}",
        "🤓 Pierwsze użycie Ambienta: *{22}* {21} *{23}*",
      ],
    },
    help: {
      usage: [
    ...
    nick: {
      ...
      invitationUrlActive: "❌ Ambient nie może zmieniać nicków członków grupy, kiedy link do zaproszenia (Meta) jest aktywny i jednocześnie bot nie jest administratorem grupy.",
      unableToChangeOthers: "❌ Tylko administratorzy grupy mogą zmieniać nicki innych członków!",
