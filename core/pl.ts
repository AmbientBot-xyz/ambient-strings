  ...
  commands: {
    ...
    spotify: {
      usage: [
        ...
        "\n⭐ *{1} toputwory <@użytkownik (opcjonalnie)>* {2} Pozwala sprawdzić Twoje najczęściej słuchane utwory lub oznaczonego użytkownika",
        "\n🤩 *{1} topartyści <@użytkownik (opcjonalnie)>* {2} Pozwala sprawdzić Twoich najczęściej słuchanych artystów lub oznaczonego użytkownika",
      ...
      profile: ["🤠 Informacje o profilu Spotify *{0}*:\n", "🆎 Nazwa: *{1}*", "🌍 Kraj: *{2}*", "👀 Liczba obserwujących: *{3}*", "🔗 Profil: {4}", "💎 Spotify Premium: *{5}*"],
      nowListening: [
