export default {
  ...
  commands: {
    ...
    apod: {
      ...
      doneVideo: "{0} Here is an Astronomy Video of the Day named *{1}*: {2}",
    ...
    help: {
      ...
      list: [
        ...
        "📸 Social (*{16}*): {17}\n",
        "🛠️ Tools (*{18}*): {19}\n",
        "✨ To see detailed information on the selected command, type *{20} <command name>*, e.g. *{20} {21}*.",
        "\n📱 This bot was created *completely free* on {22}, you can also do it to use it on your groups!",
        "\n🤗 Join our *Discord server* to stay up to date with *Ambient* news, as well as get help and answers to your questions: {23}",
      ],
      about: [
    ...
    restoration: {
      ...
      fourthSettingQuestion: [
        ...
        "1. *❌ no* - restored messages will be sent to the group where they were deleted",
        "2. *✅ yes* - restored messages will be sent in private messages to group administrators",
        "\n🪄 Send only the number corresponding to the selected setting, you can also react to this message by using 👍🏼 (variant irrelevant) to select the first setting.",
      ],
    ...
    spotify: {
      usage: [
        ...
        "\n⭐ *{1} toptracks <@user (optionally)>* {2} Allows you to check what are your or the user mentioned most listened tracks",
        "\n🤩 *{1} topartists <@user (optionally)>* {2} Allows you to check what are your or the user mentioned most listened artists",
      ...
      profile: ["🤠 Info about Spotify profile of *{0}*:\n", "🆎 Name: *{1}*", "🌍 Country: *{2}*", "👀 Followers count: *{3}*", "🔗 Profile: {4}", "💎 Spotify Premium: *{5}*"],
      nowListening: ["🎧 *{0}* {1} *Now listening*", "\n💿 *{2}* {1} *{3}*\n", "{4}", "\n💽 Album: *{5}*", "💾 Local file: *{6}*", "🎚️ Volume level: *{7}%*", "{8} Device: *{9}*"],
      recentlyPlayed: [
