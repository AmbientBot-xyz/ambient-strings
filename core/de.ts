export default {
  global: {
    notEnabled:
      "Es sieht so aus, als ob du versuchst, Ambient in einer Gruppe zu verwenden, die nicht zur erlaubten Liste im *Verwaltungspanel* hinzugefügt wurde. Bitte den Bot-Administrator, eine Gruppe hinzuzufügen, oder erstelle deinen eigenen Bot völlig kostenlos auf {0}",
    properBotIssues: [
      "Es sieht so aus, als ob du versuchst, einen Bot zu verwenden, der nicht richtig funktioniert. Informationen über den in dieser Gruppe aktivierten Bot:\n",
      "🤖 Bot-Name: *{0}*",
      "🪪 Konto: *{1}*",
    ],
    wrongBot: [
      "Es sieht so aus, als ob du versuchst, den falschen Bot zu verwenden. Informationen über den in dieser Gruppe aktivierten Bot:\n", //
      "🤖 Bot-Name: *{0}*",
      "🪪 Konto: *{1}*",
    ],
    disabledManual: "♿ Der Bot *{0}* wurde vom Administrator in dieser Gruppe deaktiviert!",
    disabledAuto: "💡 Der Bot *{0}* wurde in dieser Gruppe deaktiviert, weil er in einem anderen Bot zu den erlaubten Gruppen hinzugefügt wurde.",
    enabled: "🔘 Der Bot *{0}* wurde in dieser Gruppe aktiviert, alle Mitglieder der Gruppe können ihn jetzt verwenden.",
    eventError: [
      "💀 Ambient ist beim Versuch, das Ereignis zu verarbeiten, auf einen unbekannten Fehler gestoßen. Bitte versuche es später erneut. Der Fehler wurde automatisch an unseren Discord-Server gemeldet: {0}\n",
      "⚠️️ Name: *{1}*",
      "📜 Beschreibung: *{2}*",
      "📎 Details: {3}",
    ],
    execError: [
      "💀 Ambient ist beim Versuch, den Befehl auszuführen, auf einen unbekannten Fehler gestoßen. Bitte versuche es später erneut. Der Fehler wurde automatisch an unseren Discord-Server gemeldet: {0}\n",
      "⚠️️ Name: *{1}*",
      "📜 Beschreibung: *{2}*",
      "📎 Details: {3}",
    ],
    welcome:
      "👋🏻 Hallo, *{0}*! Mein Name ist *Ambient*, ich bin ein sicherer, effizienter und multifunktionaler Bot für Gruppen auf Messenger. Um zu sehen, was ich kann, nutze den Befehl *{1}*.\n\n🤗 Hast du Fragen oder brauchst du Hilfe? Du findest sie auf unserem *Discord server*, wo du außerdem Neuigkeiten rund um Ambient erfährst: {2}",
    welcomeGroup:
      "👋🏻 Hallo! Mein Name ist *Ambient*, ich bin ein sicherer, effizienter und multifunktionaler Bot für Gruppen auf Messenger. Um zu sehen, was ich kann, nutze den Befehl *{1}*.\n\n🤗 Hast du Fragen oder brauchst du Hilfe? Du findest sie auf unserem *Discord server*, wo du außerdem Neuigkeiten rund um Ambient erfährst: {2}",
    mentionedNotMember: "❌ Der erwähnte Nutzer ist kein Mitglied dieser Gruppe.",
    mentionedNotUser: "❌ Der erwähnte Nutzer hat Ambient noch nie verwendet.",
    commandNotFound: "❌ Befehl nicht gefunden. Tippe *{0}*, um eine Liste der verfügbaren Befehle anzuzeigen.",
    unexpectedArgs: "❌ Dieser Befehl nimmt keine Argumente an.",
    groupAdminOnly: "❌ Dieser Befehl kann nur von Gruppenadministratoren verwendet werden.",
    teamMemberOnly: "❌ Du hast keine Berechtigung, diesen Befehl zu verwenden.",
    goodNight: "🥱 Gute Nacht, *{0}*! 😴",
    happyBirthday: "🎂 Alles Gute zum Geburtstag, *{0}*! 🥳",
    outOfRange: "❌ Die ausgewählte Position existiert nicht! (max. *{0}*, *{1}* ausgewählt)",
    botAdminRequired: "❌ Der Bot muss Gruppenadministrator sein, um diesen Befehl verwenden zu können.",
    nsfwNotAllowed: "❌ NSFW-Inhalte sind in dieser Gruppe nicht verfügbar. Prüfe den Befehl *{0}*.",
    userBlacklisted: [
      "🫨 Du kannst *Ambient* nicht verwenden, weil du auf der *Blacklist* stehst.\n",
      "🤨 Denkst du, dass das ein Fehler ist? Tritt unserem *Discord server* bei und reiche einen Einspruch ein - wir werden deinen Fall prüfen: {0}",
    ],
    userPurplelisted: [
      "😤 Diese Gruppe enthält Nutzer, die auf die Purplelist gesetzt wurden. Die Verwendung von Ambient ist nicht möglich, bis die folgenden Mitglieder aus der Unterhaltung entfernt wurden:°\n",
      "{0}",
  ...
  commands: {
    ...
    bot: [
      ...
      "♨️ Average NVMe temperature: *{12}°C*",
      "💖 Supporters count: *{13}*",
      "🍒 Creation date: *{14}*",
      "😼 Author: *{15}*",
      "\n✨ _*CORE*_:",
