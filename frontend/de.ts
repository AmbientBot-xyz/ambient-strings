...
export default {
  ...
  pages: {
    ...
    bot: "Bot-Management",
    bots: "Deine Bots",
    connect: "Mit einem Konto verbinden",
    help: "Hilfe",
    loading: "Lade...",
    logout: "Abmelden",
    home: "Startseite",
    illbient: "Illbient-Datenschutzrichtlinie",
  ...
  activate: {
    ...
    failed: "Die Aktivierung ist fehgeschlagen!",
  ...
  forgot: {
    inProgress: "Wir melden dich grade an...",
  ...
  join: {
    ...
    invalidInvite: "Diese Einladung ist leider ungültig!",
    invalidInviteMore: "Die Einladung existiert nicht oder die Gruppe ist nicht mit einem Bot verbunden.",
    cardContent1: "Du wurdest eingeladen, der Gruppe beizutreten",
    cardContent2: "Gib deinen Profil-Link oder Facebook-Nutzernamen ein, um automatisch beiuitreten:",
    maleCount: "Männer",
    femaleCount: "Frauen",
    messagesCount: "Nachrichten",
    userBatch: "Profil-Link oder Nutzername",
    button: "Gruppe beitreten",
    immediateJoin: "Der Bot ist Admin oder eine Freigabe ist nicht nötig - du bist sofort drin!",
    approvalRequired: "Zugriff erst nach Freigabe - der Bot ist kein Admin und Genehmigung ist nötig.",
    ...
    addedMore: "Wenn du es nicht findest, schau im 'Sonstiges'-Ordner nach.",
