export default {
  ...
  pages: {
    ...
    bot: "Bot management",
    bots: "Your bots",
    callback: "Finalizing connection with an external service",
    connect: "Connect to an account",
    flow: "Connection with an external service",
  ...
  home: {
    placeholder: "Home page isn't available yet. Looking for a dashboard?",
  },
  join: {
  ...
  support: {
    fetching: "Fetching your support information...",
    invalid: "Invalid support link",
    invalidMore: "User not found.",
    premiumState: "Premium state",
    premiumInactive: "inactive",
    premiumActive: "active until {0}",
    selectLabel: "Months and amount",
    percentOff: "{0}% off!",
    phoneNumber: "Phone number",
    recipientAndTitle: "Recipient and title",
    amount: "Amount",
    copiedSuccessfullyPhoneNumber: "Successfully copied phone number!",
    copiedSuccessfullyRecipientAndTitle: "Successfully copied recipient and title!",
    copiedSuccessfullyAmount: "Successfully copied amount!",
    ...
    rulesPartTwo: "rules of supporting Ambient",
    whyWorth: "Why is it worth supporting?",
    tileTitle0: "No restrictions",
    tileContent0: "Use all Ambient features without any restrictions",
    tileTitle1: "Global benefits",
    tileContent1: "Your Premium includes all bots created in the Ambient system and works in all groups",
    tileTitle2: "Groups boosting",
    tileContent2: "You can boost up to 2 groups, so all their members also have no restrictions",
    tileTitle3: "Stand out from the crowd",
    tileContent3: "Your Premium status is visible in your profile information, showing that you support Ambient",
    tileTitle4: "Priority help",
    tileContent4: "Get priority help on our Ambient community Discord server",
    tileTitle5: "Simple rules",
    tileContent5: "All you need to do is phone transfer with the appropriate amount and code to get Premium",
    tileTitle6: "Experience since 2019",
    tileContent6: "For years, we have been providing entertainment and management tools to hundreds of thousands of users and tens of thousands of groups",
    tileTitle7: "No ads and privacy",
    tileContent7: "We don't display any ads and your data remains safe",
    tileTitle8: "One of a kind",
    tileContent8: "Ambient operates on an unrivaled scale and level",
    faq: "Frequently asked questions",
    faqTitle0: "Can I gift Premium to someone else?",
    faqContent0:
      "Yes, you just need to enter their identifier in the recipient and title fields instead of your own. You can find it using the command that displays profile information.",
    faqTitle1: "In my bank's app, I can only enter either the recipient or the title. What should I do?",
  ...
  callback: {
    ...
    invalidMore: "The connection timed out or the required permissions were rejected.",
    connected: "Connection successful",
    connectedMore: "Your Ambient profile has been successfully linked to the service! You can now close this page and use additional commands.",
  },
  flow: {
    checking: "Please wait, checking data...",
    invalidInit: "Invalid connection link",
    invalidInitMore: "The link is invalid or has expired. Please generate a new connection link and try again.",
    invalidTarget: "Authorization failed",
    invalidTargetMore: "The request was rejected or the authorization has expired. Please generate a new connection link and try again.",
    service: "Service",
  ...
  bots: {
    ...
    screenshotModalHint:
      "Screenshot allows you to see why we were unable to log in with the provided credentials. If they appear to be incorrect, correct them and try again. You suspect that the login process is malfunctioning? Contact us on the Discord server, we'll look into it asap.",
    failedReason: "Reason",
    ...
    deleteHint: "If you no longer need this bot, you can delete it. To use this option, bot must be turned off.",
    deleteModalHint:
      "Are you sure you want to delete this bot? If you do this, all data associated with this bot will be irretrievably deleted from our servers. To use Ambient again, you will need to create a new bot.",
    disconnectAccount: "Disconnect account",
    disconnectHint: "If you don't want the bot to have access to your Facebook account, you can disconnect it. To use this option, bot must be turned off.",
    disconnectModalHint:
      "Are you sure you want to disconnect this bot from your Facebook account? If you do this, you will not be able to run the bot until you reconnect it to an account.",
    botDisconnected: "Account has been successfully disconnected!",
    botDisconnectedMore: "This bot no longer has access to your Facebook account.",
    botDeleted: "Bot has been successfully deleted!",
    botDeletedMore: "You can now create a new bot.",
